...
class Subscription(Document):
	...
	if TYPE_CHECKING:
		...
		generate_invoice_at: DF.Literal["End of the current subscription period", "Beginning of the current subscription period", "Days before the current subscription period"]
