...
class Lead(SellingController, CRMNote):
	...
	if TYPE_CHECKING:
		...
		fax: DF.Data | None
		fb_ad_id: DF.Data | None
		fb_adset_id: DF.Data | None
		fb_campaign_id: DF.Data | None
		fb_campaign_name: DF.Data | None
		fb_form_id: DF.Data | None
		fb_form_name: DF.Data | None
		...
		source: DF.Link | None
		state: DF.Data | None
		status: DF.Literal["Lead", "Open", "Replied", "Opportunity", "Quotation", "Lost Quotation", "Interested", "Converted", "Do Not Contact", "Junk", "not interested", "Wrong Data"]
